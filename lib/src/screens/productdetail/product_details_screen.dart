...
class ProductDetailsScreen extends StatelessWidget {
  const ProductDetailsScreen({super.key, required this.pageId, this.productId});
                ...
                return Padding(
                  ...
                  child: Row(
                    ...
                    children: [
                      ...
                      GetBuilder<PopularProductController>(builder: (cont) {
                        return Row(
                          children: [
                            IncreDecrementContainer(
                              ontap: () {
                                cont.setQuantity(false);
                              },
                              icon: Icons.remove,
                            ),
                            Padding(
                              ...
                              child: MyTextWidget(
                                  title: cont.quantity.toString(),
                                  style: style.headline3
                                      ?.copyWith(color: Colors.black)),
                            ),
                            IncreDecrementContainer(
                              ontap: () {
                                cont.setQuantity(true);
                              },
                              icon: Icons.add,
                              shadow: [
                                BoxShadow(
